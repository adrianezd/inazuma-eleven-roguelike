...
- **Los 31 personajes** de `roster-data.js`, su posición, su nombre de doblaje y al menos una jugada "hissatsu" real atribuida correctamente a cada uno **se verificaron mediante búsquedas específicas** en wikis especializadas del universo Inazuma Eleven (Fandom, MyAnimeList y otras fuentes de fans). Los 16 primeros y una ronda posterior de ampliación de 5 más (Bryce Withingale/Suzuno Fuusuke, Hurley Kane/Tsunami Jousuke, Claude Beacons/Nagumo Haruya "Burn", Byron Love/Afuro Terumi "Aphrodi" y Scott Banyan/Kogure Yuuya) usan el nombre de doblaje en inglés/internacional, confirmado como el mismo que empleó el doblaje de España. Una tercera ampliación añadió 10 personajes más (David Samford/Sakuma Jirou, Archer Hawkins/Tobitaka Seiya, Aiden Froste/Fubuki Atsuya, Arion Sherwind/Matsukaze Tenma, Riccardo Di Rigo/Shindou Takuto, Gabriel García/Kirino Ranmaru, Aitor Cazador/Kariya Masaki, Víctor Blade/Tsurugi Kyousuke, Subaru Honda/Kurumada Gouichi y Nishiki Ryouma —este último conserva su nombre original en el doblaje, no es una omisión). Para esa misma ampliación se investigaron otros 10 personajes (Kageno Jin, Shishido Sakichi, Handa Shinichi, Hijikata Raiden, Saginuma Osamu, Fei Rune, Aoyama Shunsuke, Sangoku Taichi, Amagi Daichi, Matatagi Hayato) pero se descartaron del plantel por completo al no poder confirmar un nombre de doblaje real para ellos.
