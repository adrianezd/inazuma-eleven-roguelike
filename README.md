...
- Se ha priorizado deliberadamente **un plantel más pequeño y confiable frente a uno más grande con datos dudosos**: varios personajes secundarios muy conocidos de la franquicia se dejaron fuera del plantel jugable por no poder confirmar con confianza su jugada "hissatsu" concreta en el tiempo disponible para esta investigación.
